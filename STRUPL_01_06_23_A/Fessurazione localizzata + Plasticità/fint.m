function [ef]=fint(et,ex,ey,t,es)
% FINT --> The routine calculates the element force vector corresponding to the 
%  stresses in a 3 node or 4 node isoparametric element
%-------------------------------------------------------------
% INPUT:    et : Element type: 1=4 node quad 2=3 node triangle
%           ex : Nodes coordinates in x direction
%           ey : Nodes coordinates  in y direction
%           t  : Element thickness
%           es : Element stress matrix (one row for each integration point)
%
% OUTPUT:   ef : Internal force vector
%-------------------------------------------------------------
